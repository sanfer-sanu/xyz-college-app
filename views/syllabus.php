...
<div class="container">
    ...
    <div class="row">
        <div class="md-5">
            <div id="uploads">
                <form enctype="multipart/form-data" action="/plexus/views/syllabus.php" method="POST">
            ...
            <ul class="list-group">
                ...
                if(!empty($jsonUploads)){
                    ...
                    <li class="list-group-item justify-content-between">
                        ...
                        <button type="button" id="btnDelete" name="btnDelete" onclick="javascript:deleteFile(this, '<?php echo $file['filename']; ?>', 'S');">
...
if(isset($_FILES ['uploadFile'])){
    ...
    if(!$uploadTemp) {
        ...
        $uploadsResult = move_uploaded_file($uploadTemp, "../../pdf/Syllabus/$uploadName");
        if($uploadsResult){
            $add = $conn->prepare("insert into uploads (type, filename) values ('S', ?)");
                ...
                <div class="row">
                    <div class="pl-0 col-6">
                        <div class="alert alert-success" role="alert">
                            ...
                            <button class="btn btn-success btn-sm float-right" type="button" id="btnRefresh" name="btnRefresh" onclick="window.location.href='/plexus/includes/php/syllabus.php';">
